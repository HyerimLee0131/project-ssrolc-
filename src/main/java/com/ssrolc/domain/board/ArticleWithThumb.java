...
public class ArticleWithThumb {
	...
	public ArticleWithThumb(String boardTable, String categoryCode, String title,
			...
			Timestamp updateDate, String convertFileName, int fileSize) {
		super();
