						...
						<table width="100%" cellSpacing="0" summary="">
							...
							<tbody>
								...
								<tr>
									...
									<td colspan="3">
										<div class="td-left">
											<input id="etc2" name="etc2" type="text" class="text" style="width: 820px;" title="센터장명" value='' />
										</div>
									</td>
								</tr>
								<tr>
									...
									<td colspan="3">
										<div class="td-left">
											<input id="etc3" name="etc3" type="text" class="text" style="width: 820px;" title="회원명" value='' />
										</div>
									</td>
								</tr>
							</tbody>
