				...
				<div class="tbl-type-F">
					...
					<table width="100%" cellSpacing="0" summary="">
						...
						<tr>
							...
							<td colspan="3">
								<div class="td-left">
									<select name="boardCategoryCode" id="boardCategoryCode" style="width: 80px;" title="">
										<#if boardCategoryList?has_content>
											<#list boardCategoryList as boardCategory>
												<option <#if boardCategory.categoryCode == article.categoryCode > selected="selected" </#if> value="${boardCategory.categoryCode}">${boardCategory.categoryName}</option>
											</#list>
										</#if>
									</select>
								</div>
						...
						<tr>
							...
							<td colspan="3">
								<div class="td-left">
									<input name='boardTitle' id='boardTitle' type="text" class="text"  style="width: 820px;" value='${article.title}' />
								</div>
							</td>
						</tr>
						<tr>
