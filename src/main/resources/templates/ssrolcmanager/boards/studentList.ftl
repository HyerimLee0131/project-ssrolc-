...
<#include "/ssrolcmanager/left.ftl">
			...
			<div id="primary_content" class="primary-content">
				...
				<div class="btn-box float-l">
					...
					<span class="button btn-type-I"><a href="/ssrolcmanager/boards/student/new">글쓰기</a></span>
				</div>
			</div>
		</div>
	</div>
	...
	<script id="boardsTemplate" type="text/x-handlebars-template">
		...
		<tr>
			...
			<td><img src='/data/file/student/8d850e56e103ba27db8ded9f679d97cf.JPG' alt='ssangdong_thum_20141125.JPG' width='50' height='50' /></td>
			<td>
